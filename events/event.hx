...
// 	PlayState.dads = [new Character(Std.parseFloat(xPos), Std.parseFloat(yPos), character, mod)];
...
// 	PlayState.gf = new Character(800, 2600, character);
// 	PlayState.add(PlayState.gf);
// 	PlayState.gf.scrollFactor.set(0.95, 0.95);
// }

// function characterSwitchGf2(character:String) {
// 	PlayState.remove(PlayState.gf);
// 	PlayState.gf.destroy();
...
// bf2scord function boyfriendFade(duration:String, targetAlpha:String) {
